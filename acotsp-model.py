...
if __name__ == "__main__":
	folder = "./model_test/acotsp_model_exp/"
	df = get_best_confs(folder)
	...
	for i, row in df.iterrows():
		...
		for j in range(SEED, SEED + 5):
			run_acotsp(f"./acotsptesting/acotsp_executions/{i}", j, alpha, beta, rho, ants, nnls, elitistants, localsearch, dlb)